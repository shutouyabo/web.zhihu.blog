...
features:
  ...
  - title: 流媒体
    link: /video
    details:
      在线观看、下载、使用 Torrent 下载并尽情追看所有你喜爱的电影和剧集！
    icon: |
  ...
  - title: 音乐
    ...
    link: /audio
    details: 在线收听、下载并使用 Torrent 下载歌曲、播客等更多内容！
  ...
  - title: 阅读
    ...
    link: /reading
    details:
      无论你是书虫、动漫迷还是漫画爱好者，都能在这里找到你喜爱的文学作品！
  ...
  - title: Torrent 下载
    ...
    link: /torrenting
    details: 使用 BitTorrent 协议下载你喜爱的媒体内容。
  ...
  - title: Android / iOS
    ...
    link: /mobile
    details: 适用于 Android 和 iOS 的各种内容。
